...
class Car {
     ...
     * @param {string} property - gotten from the req object
     * @param {string} value - gotten from the req object
     */
    getUnsoldCarsByProperty(property, value) {
        return this.cars.filter(car => car.status.toLowerCase() === 'available' && car[property].toLowerCase() === value.toLowerCase());
    }
